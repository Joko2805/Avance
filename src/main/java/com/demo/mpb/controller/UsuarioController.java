...
public class UsuarioController {
	...
	public ResponseEntity<?> eliminar(@ApiParam(value = "Identificador del Usuario", required = true)
	...
	public ResponseEntity<?> buscarPorId(@ApiParam(value = "Identificador del Usuario", required = true)
											@PathVariable(name = "id") Integer id){
		Usuario usuario = service.buscarPorId(id);
		if(usuario == null)
			throw new ResponseStatusException(HttpStatus.NOT_FOUND);
